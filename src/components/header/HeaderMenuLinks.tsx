...
const HeaderMenuLinks = ({ isOpen, setIsOpen }: HeaderMenuLinksProps) => {
    return (
        <div className={`${isOpen ? 'opacity-100 visible' : 'opacity-0 invisible'} md:hidden fixed top-16 left-0 right-0 bg-gray-800 shadow-2xl z-20 transition-all duration-300 ease-in`}>
